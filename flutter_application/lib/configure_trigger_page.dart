...
class _ConfigureTriggerPageState extends State<ConfigureTriggerPage> {
  ...
  void _initializeDefaultParams() {
    // Paramètres par défaut basés sur le type de trigger
    if (widget.trigger.name.toLowerCase().contains('email')) {
      _controllers['from'] = TextEditingController();
      _controllers['subject'] = TextEditingController();
      _params['from'] = '';
      _params['subject'] = '';
    } else if (widget.trigger.name.toLowerCase().contains('calendar')) {
